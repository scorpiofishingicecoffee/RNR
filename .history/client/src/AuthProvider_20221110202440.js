...
// components will need to know the current user's authentication state. Passing down the authentication status to each component is redundant and leads to prop drilling so using context is a good option

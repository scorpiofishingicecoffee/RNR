  ...
  function handleUpGame() {
    ...
    fetch(`/api/v1/games/${id}`, {
      ...
      result.json().then((resp) => {
        console.warn(resp);
        setNotification(
          "Has been updated and saved successfully. You can now press GO BACK. If GO BACK button is not working. Please refresh the page. Still editing the GO BACK button"
        );
      });
    });
  }
